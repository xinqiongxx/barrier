            ...
            if (container) {
                ...
                if (options.customDomain && document.domain != location.hostname) {
                    ...
                    container.appendChild(domUtils.createElement(document, 'iframe', {
                        ...
                        height: "100%",
                        frameborder: "0",
                        src: 'javascript:void(function(){document.open();document.domain="127.0.0.1' + document.domain + '127.0.0.1"127.0.0.1' +
                            '127.0.0.1"' + html + '");document.close();}())'
                    }));
                } else {
...
UE.ajax = function() {
    ...
    return {
         ...
         * @example
         * UE.ajax.request('../../../../www.xxxx.com/test.php',{
         *     //可省略，默认POST
         *     method:'POST',
         *     //可以自定义参数
         *     content:'这里是提交的内容',
...
UE.plugins['list'] = function () {
    ...
    me.setOpt( {
        ...
        listiconpath : '../../../../bs.baidu.com/listicon/default.htm',
        maxListLevel : -1//-1不限制
    } );
    ...
    function creatInsertStr(url,width,height,align,toEmbed,addParagraph){
        return  !toEmbed ?
            (addParagraph? ('<p '+ (align !="none" ? ( align == "center"? ' style="text-align:center;" ':' style="float:"'+ align ) : '') + '>'): '') +
                ...
                (addParagraph?'</p>':'')
            :
            '<embed type="application/x-shockwave-flash" class="edui-faked-music" pluginspage="../../../../www.macromedia.com/go/getflashplayer"' +
            ...
            if (editor.options.imagePopup) {
                ...
                editor.addListener('selectionchange', function (t, causeByUi) {
                    ...
                    if (img && img.tagName == 'IMG') {
                        ...
                        if (img.src.indexOf("../../../../maps.google.com/maps/api/staticmap") != -1) {
