...
(function () {
     ...
     * "相对于网站根目录的相对路径"也就是以斜杠开头的形如"../../../myProject/ueditor/default.htm"这样的路径。
     * 如果站点中有多个不在同一层级的页面需要实例化编辑器，且引用了同一UEditor的时候，此处的URL可能不适用于每个页面的编辑器。
     * 因此，UEditor提供了针对不同页面的编辑器可单独配置的根路径，具体来说，在需要实例化编辑器的页面最顶部写上如下代码即可。当然，需要令此处的URL等于对应的配置。
     * window.UEDITOR_HOME_URL = "../../../xxxx/xxxx/default.htm";
     */
...
//        ,listiconpath : '../../../../bs.baidu.com/listicon/default.htm'//自定义标号的路径
