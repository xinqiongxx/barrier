...
$(function() {
	$(".right_toggle_fullscreen").click(function() {
		var a = $(this);
		a.hasClass("right_toggle_screen") ? (switchMenu(1), fullScrennHander(!1), a.removeClass("right_toggle_screen"), $(this).find("div").text("全屏")) : (top.switchMenu(0), "number" == typeof window.screenX ? top.fullScrennHander(!0) : top.Toast("showNoticeToast", "您的浏览器不支持全屏，如果需要，请手动按F11键。"), a.addClass("right_toggle_screen"), $(this).find("div").text("还原"))
	})
});